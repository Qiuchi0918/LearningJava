...
public class MouseDrawCircle extends Canvas implements Serializable {
    protected int xm, ym;
    ...
    class ML extends MouseAdapter {
        public void mousePressed(MouseEvent e) {
            ...
            g.dispose();
            if (actionListener != null)
                actionListener.actionPerformed(new ActionEvent(MouseDrawCircle.this, ActionEvent.ACTION_PERFORMED, null));
        }
    }
    ...
    public static void main(String[] args) {
        MouseDrawCircle bb = new MouseDrawCircle();
        try {
            bb.addActionListener(new BBL());
        } catch (TooManyListenersException e) {
        }
        Frame aFrame = new Frame("MouseDrawCircle");
